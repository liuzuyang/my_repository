...
public:
    ...
    void setupUi(QWidget *MyWidget)
    {
        ...
        pushButton_2->setGeometry(QRect(220, 90, 113, 32));
        ...
        pushButton_4->setGeometry(QRect(220, 140, 113, 32));
        pushButton_5 = new QPushButton(MyWidget);
        pushButton_5->setObjectName(QStringLiteral("pushButton_5"));
        pushButton_5->setGeometry(QRect(60, 180, 113, 32));
        pushButton_6 = new QPushButton(MyWidget);
        pushButton_6->setObjectName(QStringLiteral("pushButton_6"));
        pushButton_6->setGeometry(QRect(220, 180, 113, 32));
        pushButton_7 = new QPushButton(MyWidget);
        pushButton_7->setObjectName(QStringLiteral("pushButton_7"));
        pushButton_7->setGeometry(QRect(60, 220, 113, 32));
        pushButton_8 = new QPushButton(MyWidget);
        pushButton_8->setObjectName(QStringLiteral("pushButton_8"));
        pushButton_8->setGeometry(QRect(220, 220, 113, 32));
