...
public:
    ...
    void setupUi(QDialog *MyDialog)
    {
        ...
        pushButton->setGeometry(QRect(60, 210, 113, 32));
        pushButton_2 = new QPushButton(MyDialog);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(230, 210, 113, 32));
    ...
    void retranslateUi(QDialog *MyDialog)
    {
        ...
        pushButton->setText(QApplication::translate("MyDialog", "\351\207\215\346\226\260\347\231\273\345\275\225", nullptr));
